...
#include <cmath>
//  All user-created character variables are here.
/* To access existing variables in private, we can create a reference (Ex: "Int&Name") so that you don't have problems in having private variables and public variables; pity is that the references have to be constant, so we have to make almost a reference of a reference to be able to change data */
...
private:
//All variables are private and only accessible from references on "Public"
