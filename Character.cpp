...
void Character::printStats() const
{
    ...
    cout<< "= Defence: " << this->defence << "( +" << std::to_string(this->getAddedDefence()) << ")" <<endl;
    ...
    cout<< "= Weapon: "<< this->weapon.getName()<<" Lvl: " << this->weapon.getLevel()<< " Dam: " << this->weapon.getDamageMin() << " - " << this->weapon.getDamageMax() <<endl;
    cout<< "= Armor Head: "<< this->armor_head.getName()<<" Lvl: " << this->armor_head.getLevel()<< " Def: " << this->armor_head.getDefence() <<endl;
    cout<< "= Armor Chest: "<< this->armor_chest.getName()<< " Lvl: " << this->armor_chest.getLevel()<< " Def: " << this->armor_chest.getDefence() <<endl;
    cout<< "= Armor Arms: "<< this->armor_arms.getName()<< " Lvl: " << this->armor_arms.getLevel()<< " Def: " << this->armor_arms.getDefence() <<endl;
    cout<< "= Armor Legs: "<< this->armor_legs.getName()<< " Lvl: " << this->armor_legs.getLevel()<< " Def: " << this->armor_legs.getDefence() <<endl;
}
...
//This loops infinitely so that every level is a new level.
...
void Character::addToStat(int stat, int value)
{
    if (this->statPoints < value)
        cout << "ERROR! NOT ENOUGH STATPOINTS!" <<endl;
    else
    {
        switch (stat)
        {
        ...
        case 1:
            this->vitality += value;
            cout << "VITALITY INCREASED!" <<endl;
            break;

        case 2:
            this->dexterity += value;
            cout << "DEXTERITY INCREASED!" <<endl;
            break;

        case 3:
            this->intelligence += value;
            cout << "INTELLIGENCE INCREASED!" <<endl;
            break;
...
void Character::equipItem(unsigned index)
{
    ...
    {
        cout<<"No valid item selected!" <<endl;
    }
    else
    {
        Weapon *w = nullptr;
        ...
        else if (a != nullptr)
        {
            ...
            default:
                ...
                cout << "ERROR ARMOR TYPE INVALID!" <<endl;
                break;
            }
        }
        else
...
void Character::removeItem(const int index)
{
    if (index < 0 || index >= this->inventory.size()){
        ...
        cout << "ERROR, NOT POSSIBLE TO REMOVE ITEM, removeItem Character" <<endl;
...
const Item& Character::getItem(const int index)
{
    if (index < 0 || index >= this->inventory.size())
    {
        ...
        cout << "ERROR, NOT POSSIBLE TO REMOVE ITEM, getItem Character" <<endl;
